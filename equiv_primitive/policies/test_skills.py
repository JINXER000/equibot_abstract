...
from equiv_primitive.policies.utils.misc import  EQUIV_PRIMITIVE_PATH, get_agent, get_dataset, vis_metric_imgs
...
def main(cfg):
    ...
    # get eval datase
    # cfg.data.dataset.path=os.path.join(EQUIV_PRIMITIVE_PATH, 'data/mj_peg_hole/')
