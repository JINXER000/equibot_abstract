import torch
from equiv_primitive.policies.utils.normalizer import SingleFieldLinearNormalizer
from equiv_primitive.policies.utils.pytorch_util import  dict_apply_reduce, dict_apply_split
import numpy as np
...
def to_torch_stats(arr):
    arr = torch.from_numpy(arr).to("cuda")
    stat = {
