...
from equiv_primitive.policies.utils.misc import EQUIV_PRIMITIVE_PATH, get_agent, get_dataset
...
@hydra.main(config_path=os.path.join(EQUIV_PRIMITIVE_PATH, "equiv_primitive/policies/configs"), config_name="dmg_threading_per_skill")
def main(cfg):
    ...
    from equiv_primitive.policies.utils.misc import collate_fn
