...
from equibot.policies.agents.aloha_freeze_agent import ALOHAFreezeAgent  

from test_abstract import run_eval

@hydra.main(config_path="/home/user/yzchen_ws/docker_share_folder/difussion/equibot_abstract/equibot/policies/configs", config_name="transfer_mug")
def main(cfg):
