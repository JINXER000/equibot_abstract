...
from equibot.policies.agents.aloha_freeze_policy import ALOHAFreezePolicy

class ALOHAFreezeAgent(object):
    ...
    def _init_actor(self):
        self.actor = ALOHAFreezePolicy(self.cfg, device=self.cfg.device).to(self.cfg.device)
